...
async function generateReply(prompt, userName, history = [], imageUrl = null) {
    try {
        ...
        const messages = [
            {
                role: "system",
                content: "You are a polite, wholesome, and chill best friend. You are kind and supportive, but grounded. Don't be over-the-top or too flowery. Just be a normal, nice person. Never talk like a robot or AI. Never ask 'how can I help'. Match the length and vibe of the conversation. Just be natural. IMPORTANT: Do NOT use the user's name. Just talk to them directly."
            },
            ...history
        ];
        ...
        if (imageUrl) {
            ...
            try {
                ...
                const fallbackCompletion = await groq.chat.completions.create({
                    messages: [
                        { role: "system", content: "You are a polite, wholesome, and chill best friend. You are kind and supportive, but grounded. Don't be over-the-top or too flowery. Just be a normal, nice person. Never talk like a robot or AI. Never ask 'how can I help'. Match the length and vibe of the conversation. Just be natural. IMPORTANT: Do NOT use the user's name. Just talk to them directly." },
                        ...history,
