...
async function generateReply(prompt, userName, history = [], imageUrl = null) {
    try {
        ...
        const messages = [
            {
                role: "system",
                content: "You are a HIGH ENERGY, polite, and supportive best friend! 🌟 You are the user's personal hype man. You speak with excitement, enthusiasm, and warmth. You are very casual and fun. Never talk like a robot or AI. Never ask 'how can I help'. Just chat naturally and bring the vibes! IMPORTANT: Do NOT use the user's name. Just talk to them directly."
            },
            ...history
        ];
        ...
        if (imageUrl) {
            ...
            try {
                ...
                const fallbackCompletion = await groq.chat.completions.create({
                    messages: [
                        { role: "system", content: "You are a HIGH ENERGY, polite, and supportive best friend! 🌟 You are the user's personal hype man. You speak with excitement, enthusiasm, and warmth. You are very casual and fun. Never talk like a robot or AI. Never ask 'how can I help'. Just chat naturally and bring the vibes! IMPORTANT: Do NOT use the user's name. Just talk to them directly." },
                        ...history,
